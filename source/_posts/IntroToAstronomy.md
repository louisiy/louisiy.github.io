...
![image-20231229235047994](https://cdn.jsdelivr.net/gh/louisiy/ImageStorage/img/image-20231229235047994.png)
...
- 所有恒星具有相同的化学组成和大约相同的年龄。恒星的性质**由其质量“惟一”决定**
- **星团是研究恒星形成与演化的关键**
...
- 当密度 > 1,000千克/cm3，氦核坍缩至**电子简并**

氢燃烧继续在环绕电子简并氦核的氢壳层进行

![image-20240103192013619](https://cdn.jsdelivr.net/gh/louisiy/ImageStorage/img/image-20240103192013619.png)
...
亚巨星：寿命\~1亿年，光度增加到\~10倍太阳光度，半径、温度~？
红巨星：寿命\~1亿年，光度增加到\~1,000倍太阳光度，半径、温度~？
...
![image-20240103205844404](https://cdn.jsdelivr.net/gh/louisiy/ImageStorage/img/image-20240103205844404.png)

- ~1分钟内，激波到达He壳层
- ~几小时内，激波到达并加热恒星表面 (T=500,000K) ，以~30,000km/s 的速度猛烈
  抛射外层物质
- 大质量恒星最终以剧烈的II型超新星的形式爆炸
...
主序结束点：仍在主序带上的最大质量恒星的位置，随时间移向更小质量恒星，确定**星团年龄**
...
![image-20240103210537087](https://cdn.jsdelivr.net/gh/louisiy/ImageStorage/img/image-20240103210537087.png)
...
![image-20240103210831837](https://cdn.jsdelivr.net/gh/louisiy/ImageStorage/img/image-20240103210831837.png)
...
![image-20240103210845333](https://cdn.jsdelivr.net/gh/louisiy/ImageStorage/img/image-20240103210845333.png)
...
![image-20240103211225598](https://cdn.jsdelivr.net/gh/louisiy/ImageStorage/img/image-20240103211225598.png)
...
![image-20240103211308936](https://cdn.jsdelivr.net/gh/louisiy/ImageStorage/img/image-20240103211308936.png)

内环的演化

![image-20240103211325974](https://cdn.jsdelivr.net/gh/louisiy/ImageStorage/img/image-20240103211325974.png)
...
![image-20240103211940160](https://cdn.jsdelivr.net/gh/louisiy/ImageStorage/img/image-20240103211940160.png)
...
![image-20240103213358022](https://cdn.jsdelivr.net/gh/louisiy/ImageStorage/img/image-20240103213358022.png)
...
![image-20240103213619964](https://cdn.jsdelivr.net/gh/louisiy/ImageStorage/img/image-20240103213619964.png)
...
![image-20240103214451776](https://cdn.jsdelivr.net/gh/louisiy/ImageStorage/img/image-20240103214451776.png)
...
![image-20240103214549725](https://cdn.jsdelivr.net/gh/louisiy/ImageStorage/img/image-20240103214549725.png)

- 距离视界一定距离的光子可以环绕黑洞运动
- 视界是绝对的，与观测者无关。它是时空有去无返的分界线
- 视界是事件能被探知的极限

![image-20240103214627445](https://cdn.jsdelivr.net/gh/louisiy/ImageStorage/img/image-20240103214627445.png)
...
- 吸积物质引力势能→动能→热能→X射线辐射
  $L_x = \frac{GM\dot{M}}{R}=\eta\dot{M}c^2$其中为$\dot{M}$吸积率，R为半径
- 能量转换效率$\eta = \frac{GM}{Rc^2}$（仅与天体的致密程度有关）
...
![image-20240120160827526](https://cdn.jsdelivr.net/gh/louisiy/ImageStorage/img/image-20240120160827526.png)
...
![](https://cdn.jsdelivr.net/gh/louisiy/ImageStorage/img/image-20240120160846949.png)
...
![image-20240120164309874](https://cdn.jsdelivr.net/gh/louisiy/ImageStorage/img/image-20240120164309874.png)
...
![image-20240120192823005](https://cdn.jsdelivr.net/gh/louisiy/ImageStorage/img/image-20240120192823005.png)
...
![image-20240120193916914](https://cdn.jsdelivr.net/gh/louisiy/ImageStorage/img/image-20240120193916914.png)
...
![image-20240120194158277](https://cdn.jsdelivr.net/gh/louisiy/ImageStorage/img/image-20240120194158277.png)
...
![image-20240120194543333](https://cdn.jsdelivr.net/gh/louisiy/ImageStorage/img/image-20240120194543333.png)
...
- 1784年, 查尔斯梅西耶（1730–1817）发表了包含103（110）个 “星云” 的《星团星云表》
...
![image-20240120201855255](https://cdn.jsdelivr.net/gh/louisiy/ImageStorage/img/image-20240120201855255.png)
...
![image-20240120202056066](https://cdn.jsdelivr.net/gh/louisiy/ImageStorage/img/image-20240120202056066.png)
...
![image-20240120202801752](https://cdn.jsdelivr.net/gh/louisiy/ImageStorage/img/image-20240120202801752.png)
...
![image-20240120204443150](https://cdn.jsdelivr.net/gh/louisiy/ImageStorage/img/image-20240120204443150.png)
...
- 地球运动的朝向与背向方向的温度相对于平均值升高/下降~10^-3
  （蓝色：2.724 K ，红色：2.732 K）

- $\Delta T=3.353mK$

![image-20240120214919971](https://cdn.jsdelivr.net/gh/louisiy/ImageStorage/img/image-20240120214919971.png)
...
![image-20240120223221831](https://cdn.jsdelivr.net/gh/louisiy/ImageStorage/img/image-20240120223221831.png)
...
- t=10^-35 -10^-4 秒：夸克（重子）时代
  - 夸克、质子和中子与辐射处于热平衡态 
  - t~10^-10 秒，T~10^15 K：传递电弱力的W和Z粒子不能产生，弱力冻结出来（与电磁力分离）
...
![image-20240120224659219](https://cdn.jsdelivr.net/gh/louisiy/ImageStorage/img/image-20240120224659219.png)
